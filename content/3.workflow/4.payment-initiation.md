...
5. Once the PSP replies to the payment request, a returned payment status _(Pending and Accepted or Rejected)_ is propagated back to the Participant’s node. The updated status is made available as a new Corda state in the payment statuses chain.
