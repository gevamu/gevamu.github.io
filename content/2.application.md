...
The developer must include details of the PSP in order to connect the App with the Gevamu gateway associated with this PSP.
With minimal changes to the App using the Payment SDK it can work with different PSPs.
